...
public record GuiForConstructButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<GuiForConstructButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(EriniumFactionMod.MODID, "gui_for_construct_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EriniumFactionMod.addNetworkMessage(GuiForConstructButtonMessage.TYPE, GuiForConstructButtonMessage.STREAM_CODEC, GuiForConstructButtonMessage::handleData);
	}
}