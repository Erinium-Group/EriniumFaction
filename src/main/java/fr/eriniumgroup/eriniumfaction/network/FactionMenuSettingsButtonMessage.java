...
public record FactionMenuSettingsButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<FactionMenuSettingsButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(EriniumFactionMod.MODID, "faction_menu_settings_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EriniumFactionMod.addNetworkMessage(FactionMenuSettingsButtonMessage.TYPE, FactionMenuSettingsButtonMessage.STREAM_CODEC, FactionMenuSettingsButtonMessage::handleData);
	}
}