...
import fr.eriniumgroup.eriniumfaction.procedures.CurrentChunkFactionIdProcedure;
...
public class GuiForConstructScreen extends AbstractContainerScreen<GuiForConstructMenu> implements EriniumFactionModScreens.ScreenAccessor {
	...
	public void init() {
		super.init();
		imagebutton_permission = new ImageButton(this.leftPos + -32, this.topPos + -32, 256, 256,
				new WidgetSprites(ResourceLocation.parse("erinium_faction:textures/screens/permission.png"), ResourceLocation.parse("erinium_faction:textures/screens/permission_hover.png")), e -> {
