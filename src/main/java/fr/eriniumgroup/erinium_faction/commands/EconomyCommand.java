...
public class EconomyCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> d) {
        d.register(Commands.literal("money").executes(ctx -> showBalance(ctx.getSource())).then(Commands.literal("pay").then(Commands.argument("player", StringArgumentType.word()).suggests(EconomyCommand::suggestOnlinePlayers).then(Commands.argument("amount", DoubleArgumentType.doubleArg(0.01)).suggests(EconomyCommand::suggestAmounts).executes(ctx -> doPay(ctx.getSource(), StringArgumentType.getString(ctx, "player"), DoubleArgumentType.getDouble(ctx, "amount")))))).then(Commands.literal("set").requires(src -> src.hasPermission(2)).then(Commands.argument("player", StringArgumentType.word()).suggests(EconomyCommand::suggestOnlinePlayers).then(Commands.argument("amount", DoubleArgumentType.doubleArg(0)).suggests(EconomyCommand::suggestAmounts).executes(ctx -> doSet(ctx.getSource(), StringArgumentType.getString(ctx, "player"), DoubleArgumentType.getDouble(ctx, "amount")))))).then(Commands.literal("give").requires(src -> src.hasPermission(2)).then(Commands.argument("player", StringArgumentType.word()).suggests(EconomyCommand::suggestOnlinePlayers).then(Commands.argument("amount", DoubleArgumentType.doubleArg(0.01)).suggests(EconomyCommand::suggestAmounts).executes(ctx -> doGive(ctx.getSource(), StringArgumentType.getString(ctx, "player"), DoubleArgumentType.getDouble(ctx, "amount")))))).then(Commands.literal("take").requires(src -> src.hasPermission(2)).then(Commands.argument("player", StringArgumentType.word()).suggests(EconomyCommand::suggestOnlinePlayers).then(Commands.argument("amount", DoubleArgumentType.doubleArg(0.01)).suggests(EconomyCommand::suggestAmounts).executes(ctx -> doTake(ctx.getSource(), StringArgumentType.getString(ctx, "player"), DoubleArgumentType.getDouble(ctx, "amount")))))).then(Commands.literal("top").executes(ctx -> showTop(ctx.getSource(), 1)).then(Commands.argument("page", IntegerArgumentType.integer(1)).suggests(EconomyCommand::suggestPages).executes(ctx -> showTop(ctx.getSource(), IntegerArgumentType.getInteger(ctx, "page"))))));
    }
